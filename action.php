		...
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				echo '<div class="row">
							...
							<div class="col-md-4">
								<b class="net_total" style="font-size:20px; float: right; margin: 0px 50px 20px 0px" > </b>
					</div>';
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right; margin: 0px 70px 0px 0px" name="login_user_with_product" class="btn btn-info btn-lg" value="Thanh toán" >
							</form>';
					...
					echo '
						...
						<form action="/khanstore/vnpay_php/index.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input type="submit" style="float:right; margin: 0px 70px 0px 0px" name="redirect" class="btn btn-info btn-lg" value="Thanh toán">
							</form>';
				}
			}
	}
